      ...
      <main className="flex-1 p-6 lg:p-8 overflow-auto">
        ...
        <header className="flex justify-between items-center mb-8">
          ...
          <div className="flex gap-3">
            ...
            <Button variant="default" className="rounded-xl bg-indigo-600 hover:bg-indigo-500">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          {KPI.map((kpi, i) => (
            <Card key={i} className="hover:border-white/10 transition-all">
        ...
        <div className="grid lg:grid-cols-2 gap-6 mb-8">
          ...
          <Card>
            <CardHeader className="flex flex-row justify-between items-center">
              <CardTitle className="text-sm">Candidate Performance</CardTitle>
          ...
          <Card>
            <CardHeader className="flex flex-row justify-between items-center">
              <div>
                <CardTitle className="text-sm mb-2">Interview Sources</CardTitle>
            ...
            <div className="flex items-end justify-between gap-2">
              {FUNNEL.map((f, i) => (
                <div key={i} className="flex-1 text-center">
                  ...
                  <p className="text-xs font-medium text-zinc-400">{f.stage}</p>
                  <p className="text-sm font-bold text-white mt-1">{f.count}</p>
                </div>
              ))}
            </div>
          </CardContent>
                ...
                <tbody className="divide-y divide-white/5">
                  {PERFORMANCE_TABLE.map((p, i) => (
                    <tr key={i} className="hover:bg-white/[0.02]">
                      ...
                      <td className="py-3 text-sm text-white font-medium">{p.leads}</td>
                      <td className="py-3">
